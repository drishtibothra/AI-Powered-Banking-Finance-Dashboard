...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_ai_conversations_id"), "ai_conversations", ["id"], unique=False
    )
    op.create_table(
        "categories",
        sa.Column("id", sa.Integer(), nullable=False),
        ...
        sa.Column(
            "entry_type",
            sa.Enum("income", "expense", "savings", name="entrytype"),
            nullable=False,
        ),
        sa.ForeignKeyConstraint(
            ["user_id"],
    ...
    op.create_index(
        op.f("ix_monthly_summaries_id"), "monthly_summaries", ["id"], unique=False
    )
    op.create_table(
        "ai_messages",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column(
            "frequency",
            sa.Enum("one_time", "recurring_monthly", name="frequency"),
            nullable=False,
        ),
